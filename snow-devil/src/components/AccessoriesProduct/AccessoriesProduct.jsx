...
import './AccessoriesProduct.scss'
function AccessoriesProduct() {
    ...
    const { addToCart, accessories, activeItem, setItemCount, itemCount } = useContext(CartContext);
    ...
    return (
        <>
            ...
            {/* Green Box */}
            {accessories.filter(item => item.id === activeItem).map((item, i) => (
